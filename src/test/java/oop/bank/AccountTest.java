...
class AccountTest {
  ...
  void testGetOwner() {
    ...
    assertEquals("Alice DOE", account1.getOwner().getName());
  }
  ...
  void testTransfer() {
    ...
    assertEquals(600.0f, account1.getBalance(), "balance of sender shouldn't change since withdraw isn't done");
  ...
  @Test
  void testBalanceConsultation() {
    String result = account1.consultBalance();
    assertEquals("You have 1000.0 in your account", result);
  }
}
